package com.switchfully.codecoach.security.authentication;
...
public class SecuredUser implements UserDetails {
    ...
    public SecuredUser(String username, String password, Collection<UserRole> authorities, boolean enabled){
